...
const navigationItems = (props) => {
    return (
        <ul className='NavigationItems'>
            ...
            <NavigationItem link="/Projects" linkClicked={() => props.linkClicked('projects')} active={props.currentNav === 'projects' || props.currentNav === 'none' ? true : false || props.currentNav === '' ? true : false}>Projects</NavigationItem>
